...
class _OffersScreenState extends State<OffersScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Exclusive Offers', style: TextStyle(fontWeight: FontWeight.bold)),
  ...
  Widget _buildOfferList(List<Product> products, bool isLoading, Future<void> Function() onRefresh) {
    if (isLoading) {
